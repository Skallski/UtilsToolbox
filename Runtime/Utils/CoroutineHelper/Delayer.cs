...
namespace SkalluUtils.Utils.CoroutineHelper
{
    public static class Delayer
    {
        ...
        /// <returns></returns>
        public static IEnumerator InvokeAfter(Action callback, CustomYieldInstruction yieldInstruction)
        {
        ...
        /// <returns></returns>
        public static IEnumerator InvokeAfter(Action callback, YieldInstruction yieldInstruction)
        {
            yield return yieldInstruction;
            callback?.Invoke();
        }
